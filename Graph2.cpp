...
void BFS(int worldRank, int worldSize, vector<int> *& adjNode, int numberRow, int startRow, int n, bool *&isVisited, int *& parent)
{
...
void printResult(int *& parent, int n)
{
...
*/
    ...
    BFS(worldRank, worldSize, adjNode, numberRow, startRow, n, isVisited, parent);
    if (worldRank == 0)
    {
        printResult(parent, n);
        free(parent);
    }
    free(isVisited);
    if (worldRank == 0)
